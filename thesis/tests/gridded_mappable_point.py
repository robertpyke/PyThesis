...
class TestGriddedMappableItem(unittest.TestCase):
    ...
    def test_get_layer_points_as_geo_json(self):
        q = GriddedMappablePoint.get_points_as_geojson(grid_size=1).\
